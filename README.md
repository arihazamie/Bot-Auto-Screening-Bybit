...
| 4         | PnL & Persentase         |    10/10    | Formula benar: qty sudah bake-in leverage ✅, fee taker 0.055% open+close ✅, ROI/margin & ROI/balance ✅, parameter `leverage` dead dihapus dari `_calc_pnl()` — API bersih & tidak misleading ✅                                   |
...
| **Total** |                          | **125/130** | Semua fix teraplikasi. Ruang perbaikan utama: kedalaman SMC                                                                                                                                                                          |
| **Total** |                          | **121/130** | Semua fix teraplikasi. Ruang perbaikan utama: kedalaman SMC                                                                                                                                                                          |
